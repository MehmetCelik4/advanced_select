...
export default class extends Controller {
  ...
  renderLoading() {
    ...
    this.optionsTarget.replaceChildren(this.textElement("div", this.loadingClass, this.loadingTextValue))
  }

  renderError() {
    this.optionsTarget.setAttribute("aria-busy", "false")
    this.optionsTarget.replaceChildren(this.textElement("div", this.errorClass, this.errorTextValue))
  }
  ...
  get optionElements() {
    return Array.from(this.optionsTarget.querySelectorAll("[data-advanced-select-option], [data-advanced-select-add-option]")).filter((option) => !option.classList.contains("hidden"))
  }
